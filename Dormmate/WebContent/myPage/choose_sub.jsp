...
<body>
        ...
        <%
		String value = request.getParameter("id"); // choose.jsp에서 정보확인을 위해 선택한 회원의 id 가져오기
        ...
        <table id = "userpage">
       	...
       	<form method="post" action="choose_moreInfo.jsp">
        	...
        	<!-- 해당 회원의 세부사항을 확인하기 위해 아이디와 닉네임을 넘겨준다.(세부사항db에는 닉네임이 저장되어 있지 않아 출력을 위해 닉네임도 넘겨줄 필요가 있다.) -->
        </form>
        <%
		}
        %>
