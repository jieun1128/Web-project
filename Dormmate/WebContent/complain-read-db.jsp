  ...
  <body>
   ...
   id = request.getParameter("id");	// 사용자 아이디
      ...
      try {
            ...
            String sql = "select * from complain_agree where userID='"+id+"' AND tableID="+tableID;	// 사용자의 id와  해당 게시물의 tableID를 이용하여
      ...
      sql_update1 = "update complain set agree="+l_agree+", disagree="+l_disagree+" where tableID="+tableID;


      if(!rs.next()){
    	 sql_update2="insert into complain_agree values ('"+id+"', "+tableID+", "+l_hidden+")";	// notice_table에 사용자가 존재하지 않을 때
      }
      else {
    	  sql_update2="update complain_agree set agree="+l_hidden+" where userID='"+id+"' AND tableID="+tableID;
      }
