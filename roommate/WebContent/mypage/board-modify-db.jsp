...
<body>
   <%
	...
	String from_board=(String)session.getAttribute("board"), href_board=from_board.concat(".jsp");
	...
	String id = (String)session.getAttribute("id");
  	...
  	try{
        ...
        String sql = "update "+ from_board+ " set title = '"+ title+"', content = '" + content + "'where tableID = " + tableID;
